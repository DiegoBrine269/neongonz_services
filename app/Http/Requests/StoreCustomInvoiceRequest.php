...
class StoreCustomInvoiceRequest extends FormRequest
{
    ...
    public function messages(): array 
    {
        return [
            ...
            'rows.*.concept.required' => 'El concepto es obligatorio.',
            ...
            'rows.*.sat_unit_key.required' => 'La unidad de medida es obligatoria.',
            'rows.*.sat_unit_key.exists' => 'Una o más unidades de medida no son válidas.',
            'rows.*.sat_key_prod_serv.required' => 'La clave de producto o servicio es obligatoria.',
